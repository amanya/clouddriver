...
@Slf4j
public class MonitorCloudFormationAtomicOperation implements AtomicOperation<String> {
  ...
  public MonitorCloudFormationAtomicOperation(DeployCloudFormationDescription deployCloudFormationDescription) {
